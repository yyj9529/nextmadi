package com.phraselog.auth.dto;
...
public record InternalAuthPrincipal(String userId, String sessionToken) {
  ...
  public static InternalAuthPrincipal ofUser(String userId) {
    return new InternalAuthPrincipal(userId, null);
  }

  public static InternalAuthPrincipal ofSession(String sessionToken) {
